...
directory_name = sprintf('sims/sims_%s %i somata16', str_now, T);
...
parfor xx = 1:REPS
    ...
    mats.Soma = false([185,185,16]);
        
    mats.Soma(32:34,32:34,1) = 1;
    mats.Soma(32:34,72:74,2) = 1;
    mats.Soma(32:34,112:114,3) = 1;
    mats.Soma(32:34,152:154,4) = 1;

    mats.Soma(72:74,32:34,5) = 1;
    mats.Soma(72:74,72:74,6) = 1;
    mats.Soma(72:74,112:114,7) = 1;
    mats.Soma(72:74,152:154,8) = 1;

    mats.Soma(112:114,32:34,9) = 1;
    mats.Soma(112:114,72:74,10) = 1;
    mats.Soma(112:114,112:114,11) = 1;
    mats.Soma(112:114,152:154,12) = 1;

    mats.Soma(152:154,32:34,13) = 1;
    mats.Soma(152:154,72:74,14) = 1;
    mats.Soma(152:154,112:114,15) = 1;
    mats.Soma(152:154,152:154,16) = 1;
