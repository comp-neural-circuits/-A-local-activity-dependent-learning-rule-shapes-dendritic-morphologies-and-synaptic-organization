...
dir_str = '../sims/5_across_group_correlation3/';
save_dir_str = 'Videos and images/figure_5/across3/';
mkdir(save_dir_str)
...
all_selectivity_groups = cell(1, numFolders);
...
parfor k = 1:numFolders
    ...
    [accLengths, accSyns, accDens, tot_tree_length_time, dend_add_time, dend_remove_time, connect_syn_time, syn_add_time, syn_remove_time, sel, stab, sel_groups] = process_simulations(load_dir_str, REPS, N, T);
    ...
    all_selectivity_groups{k} = mean(sel_groups, 1);
...
all_selectivity_groups = cell2mat(all_selectivity_groups');
...
save([save_dir_str, 'all_data.mat'], 'folder_str', 'all_accLengths', 'all_accSyns', 'all_accDens', 'all_selectivity', 'all_selectivity_groups', 'all_stability', 'all_tot_tree_length_time', 'all_connect_syn_time', 'all_dend_add_time', 'all_dend_remove_time', 'all_syn_add_time', 'all_syn_remove_time');
