...
dir_str = '../sims/4_1_within_across_correlation_combined_selected/';
save_dir_str = 'Videos and images/figure_supp_4_1/within_across_combined_selected/';
mkdir(save_dir_str)
...
parfor k = 1:numFolders
    ...
    [accLengths, accSyns, accDens, tot_tree_length_time, dend_add_time, dend_remove_time, connect_syn_time, syn_add_time, syn_remove_time, sel, stab] = process_simulations(load_dir_str, REPS, N, T);
